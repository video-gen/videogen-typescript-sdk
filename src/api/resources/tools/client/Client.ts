...
export class ToolsClient {
     ...
     *
     * @param {VideoGenApi.ListToolExecutionsRequest} request
     * @param {ToolsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.tools.listToolExecutions()
     */
    public listToolExecutions(
        request: VideoGenApi.ListToolExecutionsRequest = {},
        requestOptions?: ToolsClient.RequestOptions,
    ): core.HttpResponsePromise<VideoGenApi.ToolExecutionListResponse> {
        return core.HttpResponsePromise.fromPromise(this.__listToolExecutions(request, requestOptions));
    }

    private async __listToolExecutions(
        request: VideoGenApi.ListToolExecutionsRequest = {},
        requestOptions?: ToolsClient.RequestOptions,
    ): Promise<core.WithRawResponse<VideoGenApi.ToolExecutionListResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as VideoGenApi.ToolExecutionListResponse,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/tools/executions");
    }
